...
import { Share2, PenSquare, Clock, CheckCircle, Calendar, Settings } from 'lucide-react'

export default function SocialLayout({ children }: { children: React.ReactNode }) {
  const pathname = usePathname()

  const navItems = [
    { href: '/social', label: 'Dashboard', icon: Share2, exact: true },
    { href: '/social/compose', label: 'Compose', icon: PenSquare },
    { href: '/social/scheduled', label: 'Scheduled', icon: Clock },
    { href: '/social/published', label: 'Published', icon: CheckCircle },
      ...
      <div className="backdrop-blur-xl bg-black/50 border-b border-light-teal/20">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-supernova text-transparent bg-clip-text bg-gradient-to-r from-hot-pink via-purple-400 to-light-teal">
                Social Media
              </h1>
              <p className="text-sm text-gray-400 font-josefin">Schedule and manage your social presence</p>
            </div>
            <Link
              href="/home"
